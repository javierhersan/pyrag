...
def main():
    ...
    documents = [
        "If the user wants to execute this function answer with: <execute> transaction(address, amount) </execute>", 
    ...
    while True:
        ...
        response = generate_response(query, client, relevant_documents)
...
def query_embeddings(query, client, index, documents, k=2):
